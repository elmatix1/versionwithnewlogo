  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[80vh] flex items-center justify-center bg-gradient-to-b from-primary/10 to-background">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-6 bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent md:text-6xl">
...
const FeatureCard = ({
  ...
  title,
  description
}: FeatureCardProps) => <Card className="bg-card/50 backdrop-blur-sm border-primary/10">
